...
public class DingNewFragment extends BaseFragment implements View.OnClickListener {
...
//                    ViewGroup.LayoutParams params = new ViewGroup.LayoutParams(px(40), px(40));
    ...
    private void initBindView() {
        ...
        rootView.findViewById(R.id.creat_todo).setOnClickListener(this);
