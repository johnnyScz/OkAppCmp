 ...
 * @author wei.yi
 */
public class DingdPopupWindow extends PopupWindow implements OnClickListener {
    ...
    public DingdPopupWindow(Context context, String type, boolean isShowDashang) {
        View view = LayoutInflater.from(context).inflate(R.layout.ding_popupwindow, null);
        ...
        if (isShowDashang) {
            ...
            this.setWidth(DensityUtil.dip2px(context, 135));
        } else {
