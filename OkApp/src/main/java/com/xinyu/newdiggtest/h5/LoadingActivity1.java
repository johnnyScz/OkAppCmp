...
public class LoadingActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configInfo = ParseConfig.getInstance(LoadingActivity1.this).getConfigInfo();
        ...
        new Thread() {
            ...
            public void run() {
                ...
                PreferenceUtil.getInstance(App.mContext).setAppUpdateTime("201909201525");
    ...
    private void checkH5() {
        ...
        OkHttpUtils.get().url(url).build().execute(new StringCallback() {
            ...
            public void onError(Call call, Exception e, int i) {
                Toast.makeText(LoadingActivity1.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                jump();
            }
    ...
    private void initView() {
        ...
        AppContext.CONTEXT = context = LoadingActivity1.this;
...
//        Intent intent = new Intent(LoadingActivity1.this, H5MainActivity.class);
