...
public class CalendarView extends ViewGroup {
    ...
    public interface OnItemClickListener {
        ...
        void onItemColorSelect(View view, CalendarBean bean);

        void onItemColorReset(View view, CalendarBean bean);

        void onItemCheckDot(View view, CalendarBean bean);
    ...
    private void setItem() {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            if (onItemClickListener != null) {
                onItemClickListener.onItemCheckDot(chidView, bean);
            }
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectPostion != -1) {
                    ...
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemColorReset(getChildAt(selectPostion), bean);
                        onItemClickListener.onItemColorSelect(getChildAt(potsion), bean);
                    }
                }
