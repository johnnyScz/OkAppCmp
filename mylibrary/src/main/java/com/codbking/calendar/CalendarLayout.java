...
public class CalendarLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        topHeigth = view1.getMeasuredHeight() + 30;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        view2.offsetTopAndBottom(bottomViewTopHeight + 30);
...
//        return isSilde || isflag || super.onInterceptTouchEvent(ev);
    ...
    private boolean isScroll(ViewGroup view2) {
        ViewGroup group = (ViewGroup) view2.getChildAt(1);
        View fistChildView = group.getChildAt(0);
        if (fistChildView == null) {
            return false;
        }
        View view3 = view2.getChildAt(1);
    ...
    public void flod() {
        startScroll(view2.getTop(), topHeigth - maxDistance + 30);
        type = 1;
    }
